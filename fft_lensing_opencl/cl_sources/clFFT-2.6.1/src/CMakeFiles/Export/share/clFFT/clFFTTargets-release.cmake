...
set_target_properties(clFFT PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/System/Library/Frameworks/OpenCL.framework"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclFFT.2.6.1.dylib"
  IMPORTED_SONAME_RELEASE "libclFFT.2.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS clFFT )
list(APPEND _IMPORT_CHECK_FILES_FOR_clFFT "${_IMPORT_PREFIX}/lib/libclFFT.2.6.1.dylib" )
...
set_target_properties(StatTimer PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/System/Library/Frameworks/OpenCL.framework"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libStatTimer.2.6.1.dylib"
  IMPORTED_SONAME_RELEASE "libStatTimer.2.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS StatTimer )
list(APPEND _IMPORT_CHECK_FILES_FOR_StatTimer "${_IMPORT_PREFIX}/lib/libStatTimer.2.6.1.dylib" )
